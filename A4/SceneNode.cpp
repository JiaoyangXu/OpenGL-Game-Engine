...
bool SceneNode::hit(glm::vec4 eye, glm::vec4 ray_direction, double* t, 
					glm::vec4* normal, int* material_type, Material** hit_material, int* number_hit) {
